                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-12">
                                ...
                                <form  class="card-form" method="post" action="javascript:readCardInfo();">
                                ...
                                <fieldset class="mb-1">
                                    ...
                                    <div class="form-group">
                                        <input 
                                         type="text" class="form-control" name="text" id="card-number-prototype"  placeholder="Card Number">

                                         <input 
                                         type="text" style="display: none;" class="form-control authorize-card-number" maxlength="19" name="number" id="card-number"  placeholder="Card Number">
                                    </div>
                                </fieldset>
                                <fieldset class="mb-1">
                                    <h5>Card Name</h5>
                                ...
                                <div class="form-actions center defualtCapture">
                                    ...
                                    <button type="submit" name="cardhidensub" style="display: none;"></button>
