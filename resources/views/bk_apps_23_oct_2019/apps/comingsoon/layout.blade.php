...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/vertical-menu-template/under-maintenance.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2018 17:19:15 GMT -->
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta name="description" content="simple pos">
    <meta name="keywords" content="simple pos">
    <meta name="author" content="PIXINVENT">
    <title>Under Maintenance - Simpleretailpos</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('theme/app-assets/css/pages/under-maintenance.min.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <!-- END Custom CSS-->
  </head>
        ...
        <div class="card border-grey border-lighten-3 px-1 py-1 box-shadow-3">
            <div class="card-block">
                <span class="card-title text-xs-center">
        			<img src="{{url('images/logo/full-logo.png')}}" class="img-fluid mx-auto d-block pt-2"  alt="logo">
        		</span>
            </div>
...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/vertical-menu-template/under-maintenance.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2018 17:19:16 GMT -->
</html>
