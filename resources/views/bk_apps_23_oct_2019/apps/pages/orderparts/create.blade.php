			...
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-card-center">
						@if(isset($ticketPartsOrder))
						<i class="icon-shopping-bag"></i> Parts Order Ticket
						@elseif(isset($edit))
									...
									<div class="row">
												...
												<select name="customer_id" class="select2 form-control">
													...
													@if(isset($customerList))
														@foreach($customerList as $pro)
															<option 
															 @if(isset($ticketPartsOrder))
															 	@if($ticketPartsOrder->customer_id==$pro->id)
															 		selected="selected" 
															 	@endif 
															 @elseif(isset($edit))
											...
											<div class="form-group">
												...
												<select name="ticket_id" class="select2 form-control">
													...
													@if(isset($ticketList))
														...
														<option 
															@if(isset($ticketPartsOrder))
															 	@if($ticketPartsOrder->ticket_id==$pro->ticket_id)
															 		selected="selected" 
															 	@endif 
															 @elseif(isset($edit))
															 	@if($dataRow->ticket_id==$pro->ticket_id)
															 		selected="selected" 
															 	@endif 
															 @endif 
														 data-value="{{$pro->payment_status}}" value="{{$pro->ticket_id}}">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" 
												@if(isset($ticketPartsOrder))
												value="{{$ticketPartsOrder->payment_status}}" readonly="readonly" 
												@elseif(isset($edit))
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" 
												@if(isset($ticketPartsOrder))
												value="{{$ticketPartsOrder->problem_name}}, {{$ticketPartsOrder->password}}, {{$ticketPartsOrder->type_n_color}}, {{$ticketPartsOrder->carrier}}, {{$ticketPartsOrder->imei}}" 
												@elseif(isset($edit))
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												@elseif(isset($ticketPartsOrder))
												value="{{$ticketPartsOrder->our_cost}}" 
												@endif 
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												@elseif(isset($ticketPartsOrder))
												value="{{$ticketPartsOrder->retail_price}}" 
												@endif 
