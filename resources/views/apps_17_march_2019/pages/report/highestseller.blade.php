	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="input-group" style="margin-top:32px;">
											...
											<a href="javascript:void(0);" data-url="{{url('report/highestseller/excel/report')}}" class="btn btn-green btn-darken-2 mr-1 change-action">
											...
											<a href="{{url('report/highestseller')}}" style="margin-left: 5px;" class="btn btn-green btn-darken-4">
