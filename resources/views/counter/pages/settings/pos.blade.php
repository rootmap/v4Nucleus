	                			...
	                			<div class="form-group row last">
	                        		...
	                        		<div class="col-md-7">
										<fieldset class="text-xs-center">
		                                    <label for="radio-i1"><img src="{{url('images/invoice_layout/a.png')}}" height="100"></label>
		                                    ...
		                                    <label for="radio-i2"><img src="{{url('images/invoice_layout/b.png')}}" height="100"></label>
