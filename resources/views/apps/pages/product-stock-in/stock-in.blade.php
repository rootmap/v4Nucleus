						...
						<form class="form">
							<div class="form-body">
									...
									<div class="form-group">
										...
										<button type="button" id="addCart" class="btn btn-green btn-accent-2" @if($userguideInit==1) data-step="2" data-intro="When you click this button then product add to shopping cart." @endif>
		...
		<div id="invoice-footer">
			<div class="row">
				<div class="col-md-12 col-sm-12 text-xs-center">
					<button type="submit" class="btn btn-green btn-accent-3" @if($userguideInit==1) data-step="4" data-intro="When you click this button then it will go to next step." @endif>
