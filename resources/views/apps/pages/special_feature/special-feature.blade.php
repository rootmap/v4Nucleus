		...
		<div class="col-md-8 offset-md-2">
						    ...
						    <div class="form-body">
									<div class="row">
										...
										<div style="height: 200px;  !important;" class="col-lg-6 col-sm-12  bg-green bg-darken-2 " @if($userguideInit==1) data-step="1" data-intro="This is a special order part. this section you will go to add a new order and see all list." @endif>
											<div class="col-md-5">
							            ...
							            <div style="height: 200px;"  class="col-lg-6 col-sm-12 bg-green bg-darken-1" @if($userguideInit==1) data-step="2" data-intro="This is a buyback section and you will go to add a new buyback, see all list and report." @endif>
							                <div class="col-md-5">
								                <div class="card-block text-xs-center" style="padding: 3rem 0px !important;">
							            ...
							            <div style="height: 200px;"  class="col-lg-6 bg-green bg-accent-3 col-sm-12 " @if($userguideInit==1) data-step="3" data-intro="This is a warranty. this section you will go to add a new warranty, warranty inventory and  see warranty report." @endif>
							                <div class="col-md-5">
								                <div class="card-block text-xs-center" style="padding: 3rem 0px !important;">
							            ...
							            <div style="height: 200px;"  class="col-lg-6 bg-green bg-lighten-1 col-sm-12" @if($userguideInit==1) data-step="4" data-intro="This is a sales return section and you will go to add a new sales return and see all return list." @endif >
							                <div class="col-md-5">
								                <div class="card-block text-xs-center" style="padding: 3rem 0px !important;">
							            ...
							            <div style="height: 200px;"  class="col-lg-6 bg-green bg-darken-1 col-sm-12" @if($userguideInit==1) data-step="5" data-intro="This is a expense voucher section and you will go to add a new expense voucher and see all expense voucher report." @endif>
							                <div class="col-md-5">
								                <div class="card-block text-xs-center" style="padding: 3rem 0px !important;">
