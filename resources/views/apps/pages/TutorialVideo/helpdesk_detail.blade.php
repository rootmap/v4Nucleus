...
<div class="row">
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header" @if($userguideInit==1) data-step="1" data-intro="Helpdesk video will show on this page." @endif>
                ...
                <div class="card-block">
                    <div class="col-md-6 offset-md-3">
                        <div class="form-group">
                           <div class="input-group mb-15"  @if($userguideInit==1) data-step="2" data-intro="You can start / pause video here." @endif>
...
<div class="row">
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header" @if($userguideInit==1) data-step="3" data-intro="Comment section & reply section here." @endif>
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    ...
                    <div class="col-md-12">
                      <div class="controls">
                        <div class="input-group"  @if($userguideInit==1) data-step="4" data-intro="Type your comment & hit enter to save your comment." @endif>
