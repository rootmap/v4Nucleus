	                ...
	                <div class="card-block">
						...
						class="form form-horizontal striped-labels" enctype="multipart/form-data">
							...
							<div class="form-actions center">
	                            <button type="button" class="btn btn-green btn-accent-1 mr-1" @if($userguideInit==1) data-step="3" data-intro="if you want clear all information then click the cancel button." @endif>
