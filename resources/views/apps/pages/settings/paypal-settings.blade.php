...
@section('title','Paypal Account Setting')
@section('content')
		...
		<div class="col-md-8 offset-md-2" @if($userguideInit==1) data-step="1" data-intro="You can add a API login id and transaction key" @endif>
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="striped-label-layout-card-center">Paypal Account Setting</h4>
	            ...
	            <div class="card-body collapse in">
	                <div class="card-block">
						<form method="post"  
						@if(isset($edit))
							action="{{url('paypal/account/update/setting')}}" 
						@else 
							action="{{url('paypal/account/setting')}}" 
						@endif
						class="form form-horizontal striped-labels">
							{{csrf_field()}}
							<div class="form-body">
	                			<div class="form-group row last">
	                        		<label class="col-md-4 label-control">PAYPAL CLIENT ID</label>
	                        		<div class="col-md-7">
										<div class="form-group">
											<input type="text" id="eventRegInput1" class="form-control border-green" placeholder="PAYPAL CLIENT ID" 
											@if(isset($edit))
							...
							<div class="form-body">
	                			<div class="form-group row last">
	                        		<label class="col-md-4 label-control">PAYPAL SECRET</label>
	                        		<div class="col-md-7">
										<div class="form-group">
											<input type="text" id="eventRegInput1" class="form-control border-green" placeholder="PAYPAL SECRET" 
											@if(isset($edit))
