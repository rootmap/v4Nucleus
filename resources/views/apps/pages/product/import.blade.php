	                ...
	                <div class="card-block">
						...
						class="form form-horizontal striped-labels" enctype="multipart/form-data">
							...
							<div class="form-actions center">
	                            <button type="button" class="btn btn-green btn-accent-2 mr-1" @if($userguideInit==1) data-step="4" data-intro="if you want clear all information then click the clear button." @endif>
	                            	<i class="icon-cross2"></i> Cancel
	                            </button>
	                            <button type="submit" class="btn btn-green btn-darken-2" @if($userguideInit==1) data-step="3" data-intro="When you fill up all information then click save button." @endif>
	                                <i class="icon-check2"></i> Save
	                            </button>
	                            <a href="{{url('file/sample_file.xlsx')}}" class="btn btn-green btn-accent-4 mr-1 change-action" @if($userguideInit==1) data-step="2" data-intro="When you click this button then open this excel and  you can see product import format." @endif>
