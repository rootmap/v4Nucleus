...
<section id="form-action-layouts">
	...
	<div class="row">
        ...
        <div class="row mb-1"@if($userguideInit==1)  data-step="1" data-intro="Barcode Sales, Product could be sold by barcode." @endif>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group" style="margin-bottom: 0px !important;">
                            <!-- basic buttons -->
                            <button type="button" class="btn btn-secondary btn-sm" @if($userguideInit==1) data-step="7" data-intro="The Discount button, gerenates a popup that allows you to discount an item." @endif data-toggle="modal" data-target="#Discount"><i class="icon-cogs"></i> Discount</button>
                            <button type="button" class="btn btn-secondary btn-sm"  @if($userguideInit==1) data-step="8" data-intro="In this option, you can change your tax option." @endif data-toggle="modal" data-target="#TaxManagement"><i class="icon-cog"></i> Change Tax</button>
                            <a href="javascript:void(0);"  @if($userguideInit==1) data-step="9" data-intro="You see current invoice number." @endif class="btn btn-secondary btn-sm"> Invoice#@if(isset($cart->invoiceID))    
                                {{$cart->invoiceID}}
                                @else
                                0
                            @endif </a>
                            <a href="{{url('sales/invoice/print/pdf/'.$last_invoice_id)}}" class="btn btn-secondary btn-sm"  @if($userguideInit==1) data-step="10" data-intro="Gives you the option to re-print your last receipt." @endif> <i class="icon-printer"></i> Last Receipt</a>
                ...
                <div class="card-blockf">
                    <div class="card-text">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tfoot id="posCartSummary">
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="3"> 
                                                <button  @if($userguideInit==1) data-step="16" data-intro="When you click clear POS button then clear the all POS screen." @endif id="clearsale" type="button" class="btn btn-green checkDrawer bg-lighten-1 btn-responsive" ><h4 style="text-transform: capitalize !important;"><i class="icon-circle-cross"></i> CLEAR POS</h4></button>      
                        ...
                        <div class="col-xs-12 button-group">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 button button2"  @if($userguideInit==1) data-step="12" data-intro="Here you can select your customer. " @endif>
