...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/vertical-menu-template/dt-extensions-buttons-column-visibility.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2018 17:20:57 GMT -->
<head>
    ...
    <title>Column Visibility - Robust Bootstrap Admin Template</title>
            ...
            <ul class="menu-content">
              ...
              <li><a href="#" data-i18n="nav.datatable_extensions.datatable_buttons.main" class="menu-item">Buttons</a>
                <ul class="menu-content">
                  ...
                  <li class="active"><a href="dt-extensions-buttons-column-visibility.10f.d" data-i18n="nav.datatable_extensions.datatable_buttons.dt_extensions_buttons_column_visibility" class="menu-item">Column Visibility</a>
                  </li>
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-6 col-xs-12">
            ...
            <p class="text-muted mb-0">Easily control the visibility of columns in DataTable</p>
          </div>
          ...
          <div class="content-header-lead col-xs-12 mt-1">
            <p class="lead">The column visibility plug-in for the DataTables Buttons extension provides a suite of buttons that can be used to very easily control the visibility of columns in a table.</p>
          </div>
        </div>
...
<!--/ State saving table -->
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="../../../app-assets/js/scripts/tables/datatables-extensions/da/datatable-visibility.mi" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  	<script>
