...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/ltr/vertical-menu-template/dt-extensions-buttons-flash-data-export.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2018 17:20:57 GMT -->
<head>
    ...
    <title>Flash Data Export - Robust Bootstrap Admin Template</title>
            ...
            <ul class="menu-content">
              ...
              <li><a href="#" data-i18n="nav.datatable_extensions.datatable_buttons.main" class="menu-item">Buttons</a>
                <ul class="menu-content">
                  ...
                  <li class="active"><a href="dt-extensions-buttons-flash-data-export.10e.d" data-i18n="nav.datatable_extensions.datatable_buttons.dt_extensions_buttons_flash_data_export" class="menu-item">Flash Data Export</a>
                  </li>
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-left col-md-6 col-xs-12">
            ...
            <p class="text-muted mb-0">Create and save files on the client-side</p>
          </div>
          ...
          <div class="content-header-lead col-xs-12 mt-1">
            <p class="lead">The Flash export buttons provide an option for legacy browsers (IE9-) to create and save files on the client-side, without any server interaction required.</p>
          </div>
        </div>
...
<!-- Hidden initialization table -->
    ...
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="../../../app-assets/js/scripts/tables/datatables-extensions/da/datatable-flash.min.333" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  	<script>
