...
class CreateRetailPosSummaryDateWisesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('retail_pos_summary_date_wises', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('retail_pos_summary_date_wises');
    }
}
